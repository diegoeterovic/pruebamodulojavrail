...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference('Bookmark.count') do
      post bookmarks_url, params: { bookmark: { category: @bookmark.category, title: @bookmark.title, url: @bookmark.url } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { category: @bookmark.category, title: @bookmark.title, url: @bookmark.url } }
